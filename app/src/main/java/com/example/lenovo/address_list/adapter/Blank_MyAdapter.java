...
public class Blank_MyAdapter extends RecyclerView.Adapter<Blank_MyAdapter.MyViewHolder> {

    List<Person> list;
    Context mContext;

    public Blank_MyAdapter(List<Person> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public Blank_MyAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Blank_MyAdapter.MyViewHolder holder, int i) {
